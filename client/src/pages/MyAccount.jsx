      ...
      <div className="profile-info col-md-9">
        <div className="panel">
          ...
          <div className="panel-body bio-graph-info pt-4">
            <button className="btn btn-outline-primary md-5">Edit</button>
            <div className="col userDetails">
              <div className="bio-row">
                <p>
                  <span> <b>Name</b> </span>: {user?.name.toUpperCase()}
                </p>
              </div>
             
              <div className="bio-row">
                <p>
                  <span> <b>Email</b> </span>: niteshkumawat0015@gmail.com
                </p>
              </div>
              <div className="bio-row">
                <p>
                  <span> <b>Mobile No.</b></span>: 8619224589
                </p>
              </div>
              <div className="bio-row">
                <p>
                  <span> <b>Address </b></span>: 1300 sector 4
                </p>
              </div>
