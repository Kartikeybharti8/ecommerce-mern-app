...
function About() {
  return (
    <div>
        ...
        <Navbar />
        <Content>
            <H1><h1>Our Story</h1></H1>
            <br />
            <p>
            A handwritten note on a piece of recycled paper and a handmade trinket is what one receives with every order, neatly wrapped in eco-friendly packaging from Udaipur, making it one of the most loved e-commerce portals to a discerning domestic and global audience who are enthusiastic about Indian handicraft and handloom products. The online store for handicraft, handlooms, fabrics, jewelry, paintings, and other artworks is India’s only crafts and loom retailer with a hundred percent inventory of handmade artisanal products ranging from Punjab’s phulkari dupattas and Gujarat’s bandhani sarees to Andhra’s ikkat handloom fabrics, and Odisha’s pattachitra paintings. It sources products, including jewelry, dress materials, and household items from all over India, making it the largest curated portal for art and handicraft products.
            </p>
            <br/><br/>
            <img id="image" src="https://cdn.shopify.com/s/files/1/0281/8729/5828/files/Leshemi_7_Process_Weaving_LESHEMI-80_15x10_300_1024x1024.jpg?v=1596651748"></img>
            <br/><br/><br/><br/>
            <P>
                ...
                <div class="col-4">
                    <div class="card_container">
                        ...
                        <div class="text_block">
                            ...
                            <p class="column_description">All products are personally sourced with care and respect, for the artisan, craftform and you. Pyaar se dekho and pyaar se khareedo.</p>
                        </div>
                    </div>
                </div> 
                <div class="col-4">
                    <div class="card_container">
                        ...
                        <div class="text_block">
                            ...
                            <p class="column_description">Crafts are hand-made and by nature organic, environmentally friendly. By supporting local, you are creating a sustainable future.</p>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="card_container">
                        ...
                        <div class="text_block">
                            ...
                            <p class="column_description">We partner with and support 500+ artisan families and their legacy in craft. They give us the confidence to bring these products to you.</p>
                        </div>
                    </div>
                </div>
            </div>
            <H1><h1>Our Team</h1></H1>
            <div class="row">
                <div class="col-4">
                    <div class="card_container">
